...
\paragraph{PCA}
Analiza głównych składowycg (\textit{principal component analysis}, PCA) jest metodą, która jest z powodzeniem wykorzystywana do ekstrakcji cech. Jej działanie polega na...
\paragraph{LDA}
Liniowa analiza dyskryminacyjna (\textit{linear discrimant analysis, LDA) jest metodą, którą można wykorzystać do znajdowania liniowej kombinacji cech danego zbioru, 
