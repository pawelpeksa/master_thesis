...
\hline
Najlepsza skuteczność&Skuteczność przed redukcją cech & Liczba rekordów & Metoda redukcji\\
\hline
1 & Najlepsza skuteczność & 300\\
\hline 
1 & Najlepsza skuteczność & 300\\
\hline 
 \end{tabular}
 \caption{Najlepsze wyniki dla ekstrakcji cech przy użyciu metod matematycznych} \label{table:catdogs}
\end{table}
