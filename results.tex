...
\end{tabular}
\caption{Zestawienie skuteczności wybranych modeli w przed i po przeprowadzeniu ekstrakcji cech w zależności od liczby rekordów oraz wymiarowości danych}
\label{table:fxTable}
